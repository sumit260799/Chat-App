...
const ContextMenuFriend = ({ handleDelete, userId, handleDeleteForMe }) => {
  ...
  return (
    <>
      <div
        ...
        className="menu min-w-[130px] lg:min-w-[150px] backdrop-blur-xl bg-white/70 dark:bg-black/80 shadow-lg rounded-md py-1 absolute bottom-full left-1/2 transform -translate-x-1/2 -mb-16 z-30 select-none"
      >
        ...
        >
          <MdDelete className="text-md lg:text-lg" /> <span>Delete for me</span>
        </button>
...
export default ContextMenuFriend;
